...
export function ManagerPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-3xl font-bold text-slate-900">Managers</h1>
        ...
        <form onSubmit={handleSubmit} className="flex gap-4">
          ...
          <div className="flex items-end">
            <button
              ...
              className="rounded-md bg-slate-900 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
            >
      ...
      {/* Error Display */}
      {error && (
        <div className="mb-6 rounded-lg bg-red-50 p-6 text-red-800">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <div>
                <div className="text-sm text-slate-500">Overall Points</div>
          ...
          {managerHistory && managerHistory.chips.length > 0 && (
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-semibold text-slate-900">Chip Usage</h3>
                    ...
                    {transfers
                      ...
                      .map((transfer, index) => (
                        <tr key={index} className="border-b">
                          <td className="px-4 py-2 text-slate-600">{transfer.event}</td>
          ...
          {managerInfo.leagues.classic.length > 0 && (
            <div className="rounded-lg border bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-semibold text-slate-900">Leagues</h3>
              <div className="space-y-2">
